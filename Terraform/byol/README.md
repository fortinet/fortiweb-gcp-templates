...
This module deploys a [FortiWeb Web Application Firewall WAF](https://console.cloud.google.com/marketplace/product/fortigcp-project-001/fortiweb) from Marketplace.
...
| source\_image | The image name for the disk for the VM instance. | `string` | `"projects/fortigcp-project-001/global/images/fwb-763-byol-03102025-001-w-license"` | no |
